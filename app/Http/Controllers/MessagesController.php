...
class MessagesController extends Controller
{
     ...
     */
    public function getLastMessengerActivity(Request $request)
    {
        ...
        ->select('users.id','users.name','users.mobile','users.profilepic',DB::raw('MAX(ch_messages.created_at) time'),DB::raw('MAX(ch_messages.seen) seen'),DB::raw('MAX(ch_messages.body) message'))
        ->orderBy('time', 'desc')
        ->groupBy('users.id')
